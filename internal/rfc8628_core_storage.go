...
// Source: github.com/atol-sh/fosite/handler/rfc8628 (interfaces: RFC8628CoreStorage)
//
// Generated by this command:
//
//	mockgen -package internal -destination internal/rfc8628_core_storage.go github.com/atol-sh/fosite/handler/rfc8628 RFC8628CoreStorage
//
...
func (m *MockRFC8628CoreStorage) RotateRefreshToken(ctx context.Context, requestID, refreshTokenSignature string, nextExpiry time.Time) error {
	m.ctrl.T.Helper()
...
func (mr *MockRFC8628CoreStorageMockRecorder) RotateRefreshToken(ctx, requestID, refreshTokenSignature, nextExpiry any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RotateRefreshToken", reflect.TypeOf((*MockRFC8628CoreStorage)(nil).RotateRefreshToken), ctx, requestID, refreshTokenSignature, nextExpiry)
}
